...
public final class excluirFuncionarioView extends javax.swing.JFrame {
    String cargo;
    FuncionarioController fc1=new FuncionarioController();
    public excluirFuncionarioView(String cargo) throws SQLException {
        initComponents();
        setExtendedState(excluirFuncionarioView.MAXIMIZED_BOTH);
        this.cargo=cargo;
        listarFuncionarios();
    ...
    public void listarFuncionarios() throws SQLException{
                            ...
                            funcionarios=fc1.listarFuncionario();
                            comboFuncionarios.addItem("<Selecione um funcionario>");
    ...
    private void initComponents() {
        ...
        comboFuncionarios.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void btnCadastarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastarFuncionarioActionPerformed
                        ...
                        try {
                            int select=comboFuncionarios.getSelectedIndex();
                            Funcionario funcionario=new Funcionario();
                            if(comboFuncionarios.getSelectedIndex()==0){
                                return;
                            }
                                funcionario=(Funcionario) comboFuncionarios.getItemAt(select);
                                fc1.excluir(funcionario);
                                JOptionPane.showMessageDialog(null, "Funcionario excluido com sucesso!");
                                excluirFuncionarioView.this.dispose();
    ...
    private javax.swing.JComboBox<Object> comboFuncionarios;
